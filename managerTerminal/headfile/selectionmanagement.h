#ifndef SELECTIONMANAGEMENT_H
#define SELECTIONMANAGEMENT_H
...
class selectionManagement : public QWidget
{
    Q_OBJECT
...
public:
    selectionManagement(QWidget *parent = nullptr,QSqlDatabase * GDB = nullptr);
    ~selectionManagement();

private:
    Ui::selectionManagement *ui;
};
#endif // SELECTIONMANAGEMENT_H
